...
#include "../../../../../external/qhttp/src/qhttpserverconnection.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_qhttp__server__QHttpConnection_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_qhttp__server__QHttpConnection_t qt_meta_stringdata_qhttp__server__QHttpConnection = {
    {
QT_MOC_LITERAL(0, 0, 30), // "qhttp::server::QHttpConnection"
QT_MOC_LITERAL(1, 31, 10), // "newRequest"
QT_MOC_LITERAL(2, 42, 0), // ""
QT_MOC_LITERAL(3, 43, 13), // "QHttpRequest*"
QT_MOC_LITERAL(4, 57, 3), // "req"
QT_MOC_LITERAL(5, 61, 14), // "QHttpResponse*"
QT_MOC_LITERAL(6, 76, 3), // "res"
QT_MOC_LITERAL(7, 80, 12) // "disconnected"
...
void qhttp::server::QHttpConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QHttpConnection::disconnected)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject qhttp::server::QHttpConnection::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_qhttp__server__QHttpConnection.data,
      qt_meta_data_qhttp__server__QHttpConnection,  qt_static_metacall, nullptr, nullptr}
};
...
void *qhttp::server::QHttpConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_qhttp__server__QHttpConnection.stringdata0))
